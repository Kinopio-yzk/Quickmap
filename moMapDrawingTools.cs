...
namespace MyMapObjects
{
    internal static class moMapDrawingTools
    {
        ...
        private static void DrawSimpleMarker(Graphics g, Rectangle drawingArea, double dpm, moSimpleMarkerSymbol symbol)
        {
            ...
            {
                Pen cirpen = new Pen(symbol.Color, (float)0.5);
                g.DrawEllipse(cirpen, drawingArea);
                cirpen.Dispose();
            }
            ...
            {
                Pen tripen = new Pen(symbol.Color, (float)0.5);
                PointF[] triangleA = new PointF[3];
                triangleA[0] = new PointF(drawingArea.X + drawingArea.Width / 2, drawingArea.Y);
                triangleA[1] = new PointF(drawingArea.X, drawingArea.Y + drawingArea.Height * 3 / 4);
                triangleA[2] = new PointF(drawingArea.X + drawingArea.Width, drawingArea.Y + drawingArea.Height * 3 / 4);
                g.DrawPolygon(tripen, triangleA);
                tripen.Dispose();
            }
            else if (symbol.Style == moSimpleMarkerSymbolStyleConstant.SolidTriangle)
            {
                SolidBrush tribrush = new SolidBrush(symbol.Color);
                Pen tripen = new Pen(symbol.Color, (float)0.5);
                PointF[] triangleA = new PointF[3];
                triangleA[0] = new PointF(drawingArea.X + drawingArea.Width / 2, drawingArea.Y);
                triangleA[1] = new PointF(drawingArea.X, drawingArea.Y + drawingArea.Height * 3 / 4);
                triangleA[2] = new PointF(drawingArea.X + drawingArea.Width, drawingArea.Y + drawingArea.Height * 3 / 4);
                g.FillPolygon(tribrush, triangleA);
                tribrush.Dispose();
            }
            else if (symbol.Style == moSimpleMarkerSymbolStyleConstant.Square)
            {
                Pen recpen = new Pen(symbol.Color, (float)0.5);
                g.DrawEllipse(recpen, drawingArea);
                recpen.Dispose();
            }
            ...
            {
                Pen cirpen = new Pen(symbol.Color, (float)1.0);
                SolidBrush cirbrush = new SolidBrush(symbol.Color);
                g.FillEllipse(cirbrush, (float)(drawingArea.X + 0.25 * drawingArea.Width), (float)(drawingArea.Y + 0.25 * drawingArea.Height),
                    (float)(drawingArea.Width / 2), (float)(drawingArea.Height / 2));
                g.DrawEllipse(cirpen, drawingArea);
                cirbrush.Dispose();
                cirpen.Dispose();
            }
            ...
            {
                Pen cirpen = new Pen(symbol.Color, (float)1.0);
                g.DrawEllipse(cirpen, (float)(drawingArea.X + 0.25 * drawingArea.Width), (float)(drawingArea.Y + 0.25 * drawingArea.Height),
                    (float)(drawingArea.Width / 2), (float)(drawingArea.Height / 2));
                g.DrawEllipse(cirpen, drawingArea);
                cirpen.Dispose();
                cirpen.Dispose();
